...
//선언할 경우 @Controller, @ControllerAdvice 등을 사용할 수 있고,
...
public class HelloControllerTest {
    ...
    public void hello가_리턴된다() throws Exception {
        ...
        //체이닝이 진원되어 아래와 같이 여러 검증 기능을 이어서 선언할 수 있습니다.
        mvc.perform(get("/hello"))
                ...
                //mvc.perform의 결과를 검증합니다.
                //응답 본문의 내용을 검증합니다.
                //Controller에서 "hello"를 리턴하기 때문에 이 값이 맞는 검증합니다.
    ...
    public void helloDto가_리턴된다() throws Exception {
        ...
        //param : API 테스트할 때 사용될 요청 파라미터를 설정합니다.
        //단, 값은 String만 허용됩니다.
